...
/**
 * Strings for component 'game', language 'es', version '4.0'.
 *
 * @package     game
 * @category    string
...
$string['cryptex_maxwords'] = 'Máximo número de palabras del criptograma';
$string['cryptex_minwords'] = 'Número mínimo de palabras';
$string['cryptex_maxcols'] = 'Número máximo de columnas del criptograma';
...
$string['hangman_maximum_number_of_errors'] = 'Máximo número de errores';
...
$string['helpcross'] = 'Este juego obtiene palabras del banco de preguntas de respuesta corta y genera un crucigrama aleatorio. El profesor puede configurar el número máximo de columas/filas o de palabras que contiene. El estudiante puede pulsar el botón "Revisar crucigrama" para revisar si sus respuestas son correctas. Cada crucigrama es dinámico, por lo que es diferente para cada estudiante. ';
$string['helpcryptex'] = 'Este juego obtiene palabras del banco de preguntas de respuesta corta y genera un Criptograma aleatorio. El profesor puede configurar el número máximo de columnas o de palabras que contiene. Cada criptograma es dinámico, por lo que es diferente para cada estudiante. Este criptograma hace distinción de palabras con tilde.';
$string['helphangman'] = 'Este juego obtiene palabras del banco de preguntas de respuesta corta de examen, y genera un acertijo del ahorcado. El profesor puede configurar el número de palabras que tiene cada juego, si se muestra la primera o la última letra, o si se muestra la pregunta o la respuesta al final.';
...
$string['sourcemodule_questioncategory'] = 'Seleccione una categoría del banco de preguntas';
